...
const copy = {
	en: {
		...
		sub: 'Nexor sits between your app and OpenAI, Anthropic, Gemini and 400+ more — one endpoint, weighted token plans, live logs and automatic failover.',
		cta: 'Start free',
	...
	ar: {
		...
		sub: 'نكسور تقف بين تطبيقك وOpenAI وAnthropic وGemini وأكثر من 400 موديل — نقطة اتصال واحدة، خطط توكن مرجّحة، سجلات لحظية وتحويل تلقائي.',
		cta: 'ابدأ مجاناً',
	...
	fr: {
		...
		sub: "Nexor se place entre votre application et OpenAI, Anthropic, Gemini et plus de 400 autres — un seul endpoint.",
	...
	zh: {
		...
		title: '所有模型，',
		accent: '一个网关',
		sub: 'Nexor 位于您的应用与 OpenAI、Anthropic、Gemini 等 400 多种模型之间——单一端点、加权令牌方案、实时日志与自动故障转移。',
		cta: '免费开始',
		secondary: '浏览目录',
	},
} as const;
